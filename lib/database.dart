...
class DBProvider {
  ...
  Future<Database> initDecksDB() async {
    ...
    var cardsDatabase =
        await openDatabase(path, version: 2, onCreate: _createDecksDb);
    return cardsDatabase;
  }
  ...
  void _createDb(Database db, int newVersion) async {
    ...
    await db.execute(
        '''INSERT INTO cards VALUES (1,'red','hero','rare',"Axe",NULL,NULL,2,6,10, "Axe is a man of many talents. Well one talent. The murder talent. However that seems to be enough for Axe to attract a legion of devoted fans that follow his adventures. It also probably helps that Axe's bard, Goodkind is good at what she calls 'embellishment' - Axe is unsure what the word means, but it's probably a good thing."),
                                                 ...
                                                 (3,'green','hero','common','Bristleback',NULL,NULL,NULL,8,12, "I never went to some fancy military school to learn how to beat a man half to death... that's what bars were for."),
                                                 (4,'black','hero', 'rare', 'Centaur Warruner',NULL,NULL,NULL,4,14, "The hunt is a sacred thing, and to be asked to lead it is a great honor. These centaurs claim to be the finest hunters of the Marrowfell Tribe. We shall see if any of them are worthy to claim the Horn of the Alpha."),
                                                 ...
                                                 (8,'black','hero', 'rare', 'Pugna',NULL,NULL,NULL,6,9, "The Tyler Estate. It seeks to control magic. Punish those that violate rules set by the Quorum. But I will show them that some things cannot be controlled. And when the Tyler Estate Burns, I will set my sights on Weeping Rose itself."),
                                                 (9,'red','hero', 'common', 'Sven',NULL,NULL,NULL,5,11, "I've given myself to the Vigil Knights. I will train with them. Learn their ways. Become the best... and ultimately: destroy them from within."),
                                                 (10,'red','hero', 'common', 'Tidehunter', NULL,NULL,NULL,5,11,"Tidehunter ma duże ręce"),
                                                 (11,'red','hero', 'uncommon', 'Timbersaw',NULL,NULL,NULL,4,11, "I know they think I'm crazy... and that's ok... they didn't see what I saw... see what the trees did. 'Ohh it's nature, look at the beauty of the forest.' Lies. That's not a tranquil jungle... that's a sleeping army. And unless we are prepared when that forest starts to march it will be the end of everybody."),
                                                 (12,'blue','hero', 'common', 'Ursa',NULL,NULL,NULL,7,10, "This isn't my fight. But if I don't stand with the Vhoul it's only a matter of time before the Bronze Legion comes for my people. A message needs to be sent... and it will be bloody."),
                                                 (13,'green','improvement', 'uncommon', 'Burning Oil',NULL,1,NULL,NULL,NULL, "Your tower has +2 Retaliate."),
                                                 (14,'red','spell', 'basic', 'Double Edge',NULL,1,NULL,NULL,NULL, "Give a red hero +8 Attack and -8 Armor this round."),
                                                 (15,'green','spell', 'common', 'Fight Through the Pain',NULL,1,NULL,NULL,NULL, "Give a red hero +2 Armor this round. Get initiative."),
                                                 (16,'blue','spell', 'basic', 'Kraken Shell',NULL,1,NULL,NULL,NULL, "Modify a red hero with +1 Armor.  Get initiative."),
                                                 ...
                                                 (19,'blue','creep', 'common', 'Bronze Legionnaire',NULL,2,2,2,4, "The Red Mist Horde is on the march, looting and destroying every city that stands between them and our great capital of Stonehall. If we wish to protect our home...if we wish to stop these monsters... we must be willing to do whatever it takes."),
                                                 (20,'red','spell', 'common', 'Defensive Stance',NULL,2,NULL,NULL,NULL, "Give a hero +3 Armor this round."),
                                                 (21,'green','spell', 'basic', 'Duel',NULL,2,NULL,NULL,NULL, "Choose an allied red hero and another unit. They battle each other."),
                                                 (22,'blue','spell', 'rare', 'Heroic Resolve',NULL,2,NULL,NULL,NULL, "Modify a red hero with 'After you  a non-item card costing 2 or less, modify this hero with +2 Health.'"),
                                                 (23,'black','spell', 'common', 'Pick a Fight',NULL,2,NULL,NULL,NULL, "Choose an allied hero. It taunts. Choose a combat target for it."),
                                                 (24,'red','spell', 'rare', 'Rising Anger',NULL,2,NULL,NULL,NULL, "Modify a red hero with 'After you  a non-item card costing 2 or less, modify this hero with +1 Attack.'") ,
                                                 (25,'green','spell', 'basic', 'Whirling Death',NULL,2,NULL,NULL,NULL, "Choose an allied red hero. Deal 2 damage to its enemy neighbors and give them -2 Attack this round."),
                                                 (26,'red','spell', 'common', 'Combat Training',NULL,3,NULL,NULL,NULL, "Modify a hero with +2 Attack."),
                                                 (27,'blue','improvement', 'rare', 'Grand Melee',NULL,3,NULL,NULL,NULL, "If there is an allied red hero in this lane, all heroes have +2 Cleave."),
                                                 ...
                                                 (29,'green','creep', 'basic', 'Loyal Beast',NULL,3,1,3,3, "When Loyal Beast deals battle damage to a unit, modify that unit with -1 Attack."),
                                                 ...
                                                 (31,'red','improvement', 'rare', 'Path of the Bold',NULL,3,NULL,NULL,NULL, "After you  a red card, modify a random ally with +1 Attack."),
                                                 (32,'blue','spell', 'uncommon', 'Rend Armor',NULL,3,NULL,NULL,NULL, "Modify a unit with -X Armor where X is its Armor."),
                                                 (33,'black','spell', 'uncommon', 'Smash Their Defenses!',NULL,3,NULL,NULL,NULL, "Condemn an improvement. Draw a card."),
                                                 (34,'green','spell', 'uncommon', 'Spot Weakness',NULL,3,NULL,NULL,NULL, "Give a hero and its allied neighbors Pierce this round. Draw a card."),
                                                 ...
                                                 (37,'green','spell', 'common', 'Crippling Blow',NULL,4,NULL,NULL,NULL, "Modify a hero with -2 Attack."),
                                                 ...
                                                 (40,'blue','improvement', 'basic', 'Nether Ward',NULL,4,NULL,NULL,NULL, "After opponent s a spell, deal 3 damage to the enemy tower.")
  ...
  void _createDecksDb(Database db, int newVersion) async {
    await db.execute(
        '''CREATE TABLE IF NOT EXISTS decks (id_deck INTEGER PRIMARY KEY, nameDeck TEXT)''');
    await db.execute('''INSERT INTO decks VALUES (1, "nazwadecku"),
           INSERT INTO decks VALUES (2, "drugideck")''');
  }
